...
public class DetailedGroupStore extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null)
            Utilities.insertFragment(this, new DetailsStoreFragment(id, groupName, groupImage,userId, adminId), DetailsFragment.class.getSimpleName());
